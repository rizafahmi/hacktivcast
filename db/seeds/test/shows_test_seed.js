  ...
  return knex('shows').del()
    .then(function () {
      return Promise.all([
        ...
        knex('shows').insert({title: 'HACTIVcast Series', description: 'Sebuah screencast series tentang pemrograman NodeJS, JavaScript, GIT, GitHub, VIM, editor dan teknologi lain yang terkait'}),
